...
# Test directories
path_P0_1 = os.path.join(EA_path, 'P0_1-1')  # This is the folder P0_1-1, renamed for convenience
...
P0_2_df = P0_2.feature_extr(threshold, counts, clase='[0]', test_id='P0_2', max_trai=111)
P0_3_df_previo = P0_3.feature_extr(threshold, counts, clase='[0]', test_id='P0_3', max_trai=86) # Repair file
P0_3_df = P0_3_df_previo[50:] # File 3 only takes the second test (100 depends on P0_3_previo)
P0_3_df['time'] = P0_3_df['time'] - 375 # Change time by taking only the second test
P0_4_df = P0_4.feature_extr(threshold, counts, clase='[0]', test_id='P0_4', max_trai=401)
P0_5_df = P0_5.feature_extr(threshold, counts, clase='[0]', test_id='P0_5', max_trai=385)
P0_6_df = P0_6.feature_extr(threshold, counts, clase='[0]', test_id='P0_6', max_trai=460)

P90_1_df = P90_1.feature_extr(threshold, counts, clase='[90]', test_id='P90_1', max_trai=28)
P90_2_df = P90_2.feature_extr(threshold, counts, clase='[90]', test_id='P90_2', max_trai=56)
P90_3_df = P90_3.feature_extr(threshold, counts, clase='[90]', test_id='P90_3', max_trai=130)
P90_4_df = P90_4.feature_extr(threshold, counts, clase='[90]', test_id='P90_4', max_trai=616)

P0_90_1_df = P0_90_1.feature_extr(threshold, counts, clase='[0-90]', test_id='P0_90_1', max_trai=200)
P0_90_2_df = P0_90_2.feature_extr(threshold, counts, clase='[0-90]', test_id='P0_90_2', max_trai=440)
P0_90_3_df = P0_90_3.feature_extr(threshold, counts, clase='[0-90]', test_id='P0_90_3', max_trai=474)
P0_90_4_df = P0_90_4.feature_extr(threshold, counts, clase='[0-90]', test_id='P0_90_4', max_trai=428)

P0_90W_1_df = P0_90W_1.feature_extr(threshold, counts, clase='[0-90W]', test_id='P0_90W_1', max_trai=220)
P0_90W_3_df = P0_90W_3.feature_extr(threshold, counts, clase='[0-90W]', test_id='P0_90W_3', max_trai=270)

P45_2_df = P45_2.feature_extr(threshold, counts, clase='[45]', test_id='P45_2', max_trai=100)
P45_3_df = P45_3.feature_extr(threshold, counts, clase='[45]', test_id='P45_3', max_trai=180) # For tsne originally was at 520
P45_4_df = P45_4.feature_extr(threshold, counts, clase='[45]', test_id='P45_4', max_trai=304)

PQ_1_df = PQ_1.feature_extr(threshold, counts, clase='[Q]', test_id='PQ_1', max_trai=211)
PQ_2_df = PQ_2.feature_extr(threshold, counts, clase='[Q]', test_id='PQ_2', max_trai=109)
PQ_3_df = PQ_3.feature_extr(threshold, counts, clase='[Q]', test_id='PQ_3', max_trai=166)
PQ_4_df = PQ_4.feature_extr(threshold, counts, clase='[Q]', test_id='PQ_4', max_trai=318)
...
P0_3_df_previo = P0_3.feature_extr(threshold, counts, clase='[0]', test_id='P0_3', max_trai=187) # Repair file
P0_3_df = P0_3_df_previo[111:] # File 3 only takes the second test (100 depends on P0_3_previo)
P0_3_df['time'] = P0_3_df['time'] - 375 # Change time by taking only the second test
...
P90_1_df = P90_1.feature_extr(threshold, counts, clase='[90]', test_id='P90_1', max_trai=100)
P90_2_df = P90_2.feature_extr(threshold, counts, clase='[90]', test_id='P90_2', max_trai=425)
...
P0_90_1_df = P0_90_1.feature_extr(threshold, counts, clase='[0-90]', test_id='P0_90_1', max_trai=417)
...
P0_90_4_df = P0_90_4.feature_extr(threshold, counts, clase='[0-90]', test_id='P0_90_4', max_trai=557)

P0_90W_1_df = P0_90W_1.feature_extr(threshold, counts, clase='[0-90W]', test_id='P0_90W_1')
P0_90W_3_df = P0_90W_3.feature_extr(threshold, counts, clase='[0-90W]', test_id='P0_90W_3')

P45_2_df = P45_2.feature_extr(threshold, counts, clase='[45]', test_id='P45_2', max_trai=143)
P45_3_df = P45_3.feature_extr(threshold, counts, clase='[45]', test_id='P45_3') # For tsne originally was at 520
...
PQ_4_df = PQ_4.feature_extr(threshold, counts, clase='[Q]', test_id='PQ_4', max_trai=431)
