...
# =============================================================================
plot_dbi(
    dbi_kmeans, dbi_dbscan, figure_path, save=False
)  # Needs to have been executed for different target_clusters
...
# Filtered hits
# =============================================================================
hits_filtered = hits.drop(
    ["Class", "amplitude", "energy", "time_norm", "counts"], axis=1
).copy()
